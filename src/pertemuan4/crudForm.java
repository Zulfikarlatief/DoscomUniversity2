...
public class crudForm extends javax.swing.JFrame {
    ...
    crudControl control = new crudControl();
    ...
    public void isitabel(){
        ...
        try {
            ...
            list = control.loadDbModel();
        } catch (Exception e) {
            System.out.println("error load database "+e.getMessage());
        }
    ...
    public void tambah(){
        ...
        try {
            control.isiTabelCrud(crud);
        } catch (Exception e) {
            System.out.println("error input database "+e.getMessage());
        }
